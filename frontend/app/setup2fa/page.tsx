            ...
            <Card className="w-full max-w-md p-2 bg-white">
                ...
                <CardContent className="flex flex-col items-center space-y-4">
                    ...
                    <div className="w-full space-y-4">
                        <Input id="qr-code" placeholder="Enter code" value={code}
                               onChange={e => setCode(e.target.value)}/>
                        <Button
                            className="w-full rounded-lg bg-black py-3 px-6 font-bold text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
